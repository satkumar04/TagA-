...
public class OnlineVehiclesAdapter extends RecyclerView.Adapter<OnlineVehiclesAdapter.OnlineVehiclesViewHolder> {
    ...
    public OnlineVehiclesAdapter(Context mContext, List<VehiclesBean> onlineVehiclesList, String query) {
    ...
    @Override
    public OnlineVehiclesViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itmView = LayoutInflater.from(parent.getContext()).inflate(R.layout.allvehiclestxt, parent, false);
        return new OnlineVehiclesViewHolder(itmView);
    }

    @Override
    public void onBindViewHolder(OnlineVehiclesViewHolder holder, int position) {
        ...
        /*if (vhclbn.getDevice_Status().equals("1")) {
            holder.imgvehiclests.setBackgroundResource(R.drawable.online);
        } else if (vhclbn.getDevice_Status().equals("2")) {
            holder.imgvehiclests.setBackgroundResource(R.drawable.movingimg);
        }
*/
    }
    ...
    public final class OnlineVehiclesViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {

        TextView txtvehiclename, txtregno;
        LinearLayout lv_allvehicles;
        ImageView imgvehiclests;

        public OnlineVehiclesViewHolder(View itemView) {
            super(itemView);
