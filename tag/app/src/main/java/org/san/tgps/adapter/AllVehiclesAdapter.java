...
public class AllVehiclesAdapter extends RecyclerView.Adapter<AllVehiclesAdapter.AllVehiclesViewHolder> {
    ...
    public AllVehiclesAdapter(Context mContext, List<VehiclesBean> allVehiclesList, String query) {
    ...
    public void onBindViewHolder(AllVehiclesViewHolder holder, int position) {
        ...
        if (vhclbn.getDevice_Status().equals("0")) {
            holder.imgvehiclests.setBackgroundResource(R.drawable.reddrive);
